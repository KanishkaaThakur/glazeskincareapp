...
const Navbar = () => {
    ...
    // 1. Create a "Ref" to track the dropdown menu element
    ...
    // 2. MAGIC FIX: Listen for clicks outside the menu to close it
    useEffect(() => {
        const handleClickOutside = (event) => {
            // If the menu is open AND the click was NOT inside the menu...
            if (dropdownRef.current && !dropdownRef.current.contains(event.target)) {
                setDropdownVisible(false); // Close it!
            }
        };
            ...
            { token ? (
                <>
                    ...
                    <div className='flex items-center gap-6'>
                        ...
                        {/* 3. ATTACH THE REF HERE so we know what to track */}
