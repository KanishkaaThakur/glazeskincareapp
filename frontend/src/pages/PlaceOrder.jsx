...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async () => {
    ...
    // 1. MANUAL VALIDATION (Prevents empty submissions)
        ...
        case 'razorpay':
          ...
          if (responseRazorpay.data.success) {
            initPay(responseRazorpay.data.order);
             ...
             console.log("Backend Error:", responseRazorpay.data);
  ...
  return (
    // NOTE: Used <div> instead of <form> to prevent browser blocking
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            {/* Explicit onClick and z-index to ensure it's clickable */}
            <button onClick={onSubmitHandler} className='bg-black text-white px-16 py-3 text-sm active:bg-gray-700'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
